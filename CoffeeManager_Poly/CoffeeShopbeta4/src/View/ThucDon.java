...
public class ThucDon extends javax.swing.JFrame {
    ...
    public ThucDon() {
        ...
        JLabel[] lb = new JLabel[20];
            ...
            lbt[i].setText(" Giá : "+Gia+" VNĐ" ); 
            lbt[i].setFont(new Font("ARIAL",1, 28));
            lbt[i].setForeground(Color.RED);
            lb[i].setText(TenSP); 
            lb[i].setFont(new Font("ARIAL",3, 22));
           lb[i].setIcon(new ImageIcon(new ImageIcon(getClass().getResource(URL)).getImage().getScaledInstance(lb[i].getWidth(), lb[i].getHeight(), Image.SCALE_SMOOTH)));
